      ...
      <div class="overlay-metric-top">
        <div class="overlay-metric-label">
          ...
          <div class="overlay-metric-text">
            ...
            <span v-if="prefs.showHardwareInfo" class="overlay-metric-hardware">{{ metrics.cpu.hardwareLabel }}</span>
          </div>
        </div>
        <span v-if="prefs.showPercent" class="overlay-metric-value" :class="usageClass(metrics.cpu.usagePct, 'cyan')">
      ...
      <div class="overlay-metric-top">
        <div class="overlay-metric-label">
          ...
          <div class="overlay-metric-text">
            ...
            <span v-if="prefs.showHardwareInfo" class="overlay-metric-hardware">{{ metrics.gpu.hardwareLabel }}</span>
          </div>
        </div>
        <span v-if="prefs.showPercent" class="overlay-metric-value" :class="usageClass(metrics.gpu.usagePct, 'pink')">
      ...
      <div class="overlay-metric-top">
        <div class="overlay-metric-label">
          ...
          <div class="overlay-metric-text">
            ...
            <span v-if="prefs.showHardwareInfo" class="overlay-metric-hardware">{{ metrics.memory.hardwareLabel }}</span>
          </div>
        </div>
        <span v-if="prefs.showPercent" class="overlay-metric-value" :class="usageClass(metrics.memory.usagePct, 'cyan')">

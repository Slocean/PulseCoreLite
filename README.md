...
# PulseCore Lite v1.7.7 <img src="src/static/img/ice_logo.webp" alt="Logo" height="28" />
...
- 发布流程升级：新增 GitHub Actions 自动发布工作流，并同步版本号至 1.7.7
...
- Upgrade release engineering with a new GitHub Actions release workflow and bump version to 1.7.7
